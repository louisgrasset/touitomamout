...
export const CACHE_PATH = `${STORAGE_DIR}/cache.${INSTANCE_ID.toLowerCase().trim().replaceAll(' ', '_')}.json`;
export const COOKIES_PATH = `${STORAGE_DIR}/cookies.${INSTANCE_ID.toLowerCase().trim().replaceAll(' ', '_')}.json`;
